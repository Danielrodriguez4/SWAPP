...
<body background="assets/imagen/proyecto.jpg" class="hold-transition login-page">
<div class="login-box">
  <div style="background-color:#000000; border-color:white;" class="card card-outline card-primary">
