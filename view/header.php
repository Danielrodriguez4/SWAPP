...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="assets\imagen\logo.jpg"  alt="" height="120" width="120">
  </div>
<!-- Navbar -->
<nav class="main-header navbar navbar-expand navbar-dark navbar-light">
  ...
  <aside style="background-color:#000000;" class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
