...
<body background="assets/imagen/proyecto.jpg"  class="hold-transition register-page">
    <div class="register-box">
        <div style="border-color:white; background-color:#000000;" class="card card-outline card-primary">
            <div class="card-header text-center">
             <a style="color: white;" href="/" class="brand-link">
                <img src="assets\imagen\logo.jpg" alt="" class="brand-image img-circle elevation-3" style="opacity: .8">
                <span  style="font-family: 'Seymour One', sans-serif;" class="brand-text font-weight-light">SWAPP</span>
             </a>
            </div>
            <div class="card-body">
